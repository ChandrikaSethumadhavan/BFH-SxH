...
from ml_pipeline.external.endovit_mae import models_vit
from ml_pipeline.external.endovit_mae.util.pos_embed import interpolate_pos_embed
from ml_pipeline.external.endovit_mae.util import lr_decay as lrd
...
def prepare_mae_model(model_type, nb_classes, drop_path, pool_type, mae_ckpt, freeze_weights, reinit_n_layers=-1, return_optimizer_groups=False, weight_decay=0., layer_decay=1.0, verbose=True, debug=False):
    ...
    if (return_optimizer_groups):
        mae_dict["param_groups"] = param_groups
